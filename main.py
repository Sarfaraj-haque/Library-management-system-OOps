...
if __name__ == "__main__":
    ...
    print("\t\t\t\t\t\t\t♦♦♦♦♦♦♦ WELCOME TO THE KOLKATA LIBRARY ♦♦♦♦♦♦♦\n")
    ...
    while (True):
        ...
        try:
            ...
            if usr_response == 1:  # listing
                Kollibrary.displayAvailableBooks()
            elif usr_response == 2:  # borrow
                Kollibrary.borrowBook(
                    input("Enter your name: "), student.requestBook())
            elif usr_response == 3:  # return
                Kollibrary.returnBook(student.returnBook())
            elif usr_response == 4:  # donate
                Kollibrary.donateBook(student.donateBook())
